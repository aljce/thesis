...
need to introduce an axiomamtic method of computing integer division. In order
to use the results of integer division a user usually requires both the quotient
...
order to do this we need to rename the old exponential and all it's associated
